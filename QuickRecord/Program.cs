...
// ───── 供Azure Apps資料紀錄流呈現(可註解，需要再開) ─────
//Console.WriteLine("MyDBConn = " +
//    builder.Configuration.GetConnectionString("MyDBConn") ?? "(null)");
//Console.WriteLine("TenantId = " +
//    builder.Configuration["AzureAd:TenantId"] ?? "(null)");
